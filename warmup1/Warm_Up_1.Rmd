---
title: "warmup01-Uzziel-Valencia.Rmd"
...
>"There were a lot of explosions for two people _blending in_."
...
* Original recipe can be found [_here!_](https://smittenkitchen.com/2011/01/mushroom-and-farro-soup/)
...
In Cartesian coordinates, if **p** \(= (p_1, p_2,..., p_n) \) and **q** \(= (q_1, q_2,..., q_n) \) are two points in Euclidean _n-space_, then the distance (d) from **p** to **q**, or from **q** to **p** is given by the Pythagorean formula:
...
The position of a point in a Euclidean _n-space_ is a Euclidean vector. So, **p** and **q** may be represented as Euclidean vectors, starting from the origin of the space (initial point) with their tips (terminal points) ending at the two points. The **Euclidean norm**, or **Euclidean length**, or **magnitude** of a vector measures the length of the vector:
